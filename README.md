...
- 자체적으로 실시한 설문조사 결과에 따르면, 부산캠퍼스 학생 101명 중 37명은 택시를 주로, 많이 이용한다고 답하였으나, 택시 요금 적절도에 관한 질문에는 78명이 ‘매우 적절하지 않음‘, 혹은 ’적절하지 않음‘을 선택하였음.
