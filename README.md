...
이에 순환버스 내 다중밀집사고 우려, 매우 낮은 만족도, 현실적으로 불가능한 증차 등의 문제를 해결하기 위해, 순환버스를 대체할 다른 선택지. 즉 공유 택시 서비스를 만들어 학생들에게 보급하고자 함.
...
- 현재 밀양캠퍼스-밀양역 간 현존하는 대중교통은 버스뿐으로, 배차간격이 평일 1~2시간 동안이라 
...
- 계정이 있는 경우 user type이 사용자인 경우 *사용자 페이지*로, 택시기사인 경우 *택시 기사 페이지*로 이동함
  ![로그인 시연 영상](https://github.com/user-attachments/assets/0fa80ea0-569c-42e2-9436-2d7735693bd9)
