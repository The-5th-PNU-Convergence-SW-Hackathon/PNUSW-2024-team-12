...
| S3 | 매칭 시작               | - 택시에 함께 탈 사용자를 매칭 |
| S4 | 출발하기              | - 매칭을 만든 사용자의 기능 <br/> - 클릭 시 택시를 호출 <br/>  - 최소 인원의 조건을 만족해야 택시 호출 가능 |
| S5 | 매칭 취소          | - 매칭을 만든 사용자의 기능 <br/> - 클릭 시 매칭이 취소 |
| S6 | 매칭 나가기               | - 매칭에 참여한 사용자의 기능 <br/> - 클릭 시 참여하고 있는 매칭에서 떠날 수 있음 |
| S7 | 기사 정보              | - 이름, 자동차 번호 등의 정보를 보여줌 |
| S8 | 채팅          | - 사용자들과 위치 공유를 위한 채팅 |
