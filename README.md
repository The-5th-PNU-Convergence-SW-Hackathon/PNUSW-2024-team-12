...
6 ) 빠른 매칭
- *메인페이지*의 *빠른 매칭* 버튼을 클릭하면 *빠른 매칭 페이지*로 이동한다
- 출발지와 도착지를 입력하면 소요시간, 예상 금액, 이동 경로, 지도 등이 표시된다.
- 최소인원을 설정하고 *매칭 시작하기*버튼을 클릭하면 매칭이 시작된다.
  
7 ) 매칭 예약
- *메인페이지*의 *매칭 예약* 버튼을 클릭하면 *매칭 예약 페이지*로 이동한다.
- 탑승할 날짜와 시간을 지정한다.
- *다음 단계로 넘어가기* 버튼을 클릭한다.
- 출발지와 도착지를 입력하면 소요시간, 예상 금액, 이동 경로, 지도 등이 표시된다.
- 최소인원을 설정하고 *매칭 시작하기*버튼을 클릭하면 매칭이 시작된다.
