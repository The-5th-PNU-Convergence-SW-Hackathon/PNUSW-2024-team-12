...
4 ) 시스템 플로우 차트
   ...
   방장이 *출발해요* 버튼을 클릭하면 각의 사용자들의 소유금액을 확인하여 예상금액/n + 10%의 가격의 조건을 만족     하지 않으면 택시 호출이 실패하게 됩니다. 

   만약 조건이 만족되면 각 사용자에게 예상금액/n + 10%의 가격을 결제하고 환불합니다.
...
<img src="/docs/팀원정보.jpg" width="800px" title="Title" alt="Alt text"></img>
