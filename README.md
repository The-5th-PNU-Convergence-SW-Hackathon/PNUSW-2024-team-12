...
| S1  | 아이디              | - 아이디 입력 <br/> - 중복되는 아이디인지 검증 |
| S2  | 비밀번호 | - 비밀번호 입력 |
| S3  | 비밀번호 확인                 | - 비밀번호 일치 검증 |
| S4  | 이름            | - 이름 입력 |
...
| S10 | 기사 차 번호                | - 기사 차 번호 입력 <br/> - 중복되는 차 번호인지 검증 |
| S10 | 기사 사 모델                 | - 기사 차 모델 입력 |
| S11 | 회원가입 완료                  | - 비어 있는 입력 칸이 없는지 검증 <br/> - 메일 인증 완료했는지 확인 <br/> - 조건을 만족하면 회원가입 성공|
| S12 | 아이디/비밀번호 찾기               | - 클릭 시 *아이디/비밀번호 찾기 페이지* 로 이동 |
| S13 | 로그인                        | - 클릭 시 *로그인 페이지*로 이동 |
